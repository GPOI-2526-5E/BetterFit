...
<SelectPrimitive.Portal {...portalProps}>
	...
	>
		...
		<SelectPrimitive.Viewport
			class="h-(--bits-select-anchor-height) w-full min-w-(--bits-select-anchor-width) scroll-my-1 p-1.5"
		>
			{@render children?.()}
		</SelectPrimitive.Viewport>
