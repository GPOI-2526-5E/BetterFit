...
/// <param name="DescriptionKey">Stable localization key for the permission description.</param>
public sealed record PermissionCatalogItemResponse(Guid Id, string Resource, string Action, string? DescriptionKey);
